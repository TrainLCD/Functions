 ...
 * 「〜に変更お願いします」のような依頼も報告者自身の訴えなので含める。ただし
 * 「ご協力をお願いします」は車内放送の定型句でもあるため、お願いは除外する。
 */
const ACTIONABLE =
  /(修正|改善|追加|変更|(?<!ご(協力|理解)を?)お願い|希望|要望|不具合|バグ|誤|間違|違い|違う|反映|表示|保存|再生|遅|遅延|できない|出来ない|できません|出来ません|されない|されません|しない|しません|エラー|落ちる|クラッシュ|重複|ズレ|ずれ|おかしい|ほしい|欲しい|直し|なおし|音がない|読み上げない)/;
